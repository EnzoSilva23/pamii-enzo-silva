...
export default function HomeScreen() {
  const { init, addEvent, loading, calendarId } = useCalendar();
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <Button
          title="1. Pedir permissão e criar calendário"
          onPress={init}
          disabled={loading}
        />

        <Button
          title="2. Criar evento"
          onPress={addEvent}
          disabled={!calendarId}
        />

        {calendarId && <ThemedText>✅ Calendário criado com sucesso!</ThemedText>}
      </ThemedView>
